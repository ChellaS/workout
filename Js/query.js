...
var message = {
 ...
 (function (global) {
    ...
    QueryWidget.prototype.loadQueryLabel = function(label, selector) {
        var list = "",
    ...
    QueryWidget.prototype.loadQuestion = function(question, selector, status) {
        var questionNode = "",
    ...
    QueryWidget.prototype.setContentToEditor = function(value) {
        var editor = this.editor,
        setValue = function(editor, value){editor.val(value);};
        window.setTimeout(setValue(editor, value), 10); 
    };
    
    QueryWidget.prototype.getReply = function() {
        var value = "";
        value = this.editor.val();
        return value;
    };
    
    QueryWidget.prototype.getQuestion = function() {
        var value = "";
        value = document.getElementById('question').value;
        return value;
    };

    QueryWidget.prototype.initProblemTypes = function(problemTypes, selector) {
    ...
    QueryWidget.prototype.initQyeryType = function(problemTypes, id, selector) {
    ...
    QueryWidget.prototype.loadProblemType = function(problemTypeId, selector) {
        var problemType = "";
    ...
    QueryWidget.prototype.loadQueryType = function(queryTypeId, selector) {
    ...
    QueryWidget.prototype.removeAttributes = function(attr, selector) {
    ...
    QueryWidget.prototype.setEditorReadOnly = function(mode) {
    ...
    QueryWidget.prototype.setEditor = function(editor, elem) {
        var config = {
            toolbar:
            [
    ...
    QueryWidget.prototype.getEditor = function() {
        return this.editor;
    };
    
    QueryWidget.prototype.getQueryTypes = function(queries, id) {
    ...
    QueryWidget.prototype.setQuestionEditorReadOnly = function(id, state) {
    ...
    QueryWidget.prototype.setQueryLabel = function(elem) {
        this.removeClassSelected();
        elem.classList.add("selected");
    };
    
    QueryWidget.prototype.removeClassSelected = function() {
    ...
    QueryWidget.prototype.getSelectedQueryListName = function() {
        var listName = "";
        listName = document.getElementById("query_list").getElementsByClassName("selected")[0].innerHTML;
        return listName.trim();
    };
        
    QueryWidget.prototype.getSelectedQueryName = function(selector, _class) {
